  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          // Always centered; cap height so tall forms scroll inside the viewport
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-4 -mb-4 mt-2 flex flex-col-reverse gap-2 border-t border-border bg-muted/30 p-4 sm:-mx-5 sm:-mb-5 sm:flex-row sm:justify-end sm:rounded-b-xl max-sm:-mx-4",
        className
      )}
      {...props}
    >
